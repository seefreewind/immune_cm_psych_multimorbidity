...
This repository intentionally excludes raw GWAS summary statistics, individual-level or restricted data, LD reference files, credentials, private keys, tokens and absolute local paths. License selection and persistent DOI deposition remain pending project-owner approval.

Start with [`release/communications_biology_code/README.md`](release/communications_biology_code/README.md).
